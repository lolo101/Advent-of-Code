...
class ChecksumTest {
    ...
    void should_return_zero_when_there_is_only_one_file() {
        assertEquals(0, new Checksum("9").defragmentedValue());
    }

    @Test
    void should_return_zero_when_there_is_only_one_file_and_free_space() {
        assertEquals(0, new Checksum("99").defragmentedValue());
    }

    @Test
    void should_return_second_fileId_times_its_defragmented_position() {
        assertEquals(9, new Checksum("991").defragmentedValue());
    }
    ...
    void files_fit_in_gaps() {
        // 0.1.2
        // 021.. => 0x0+1x2+2x1=4
        assertEquals(4, new Checksum("11111").defragmentedValue());
    }
    ...
    void files_must_be_split() {
        ...
        assertEquals(10, new Checksum("11112").defragmentedValue());
    }
    ...
    void files_must_be_split_with_zero_space_somewhere() {
        // 0.122
        // 0212. => 0x0 + 1x2 + 2x1 + 3x2 = 10
        assertEquals(10, new Checksum("11102").defragmentedValue());
    }
    ...
    void files_must_share_same_space() {
        ...
        assertEquals(10, new Checksum("1210101").defragmentedValue());
    }
}